...
import { CREATE_POST_COMMENT_FAILED, CREATE_POST_COMMENT_REQUEST, CREATE_POST_COMMENT_SUCCESSFUL, CREATE_POST_FAILED, CREATE_POST_REQUEST, CREATE_POST_SUCCESSFUL, DELETE_POST_COMMENT_FAILED, DELETE_POST_COMMENT_REQUEST, DELETE_POST_COMMENT_SUCCESSFUL, DELETE_POST_FAILED, DELETE_POST_REQUEST, DELETE_POST_SUCCESSFUL, EDIT_POST_COMMENT_FAILED, EDIT_POST_COMMENT_REQUEST, EDIT_POST_COMMENT_SUCCESSFUL, EDIT_POST_FAILED, EDIT_POST_REQUEST, EDIT_POST_SUCCESSFUL, FILTER_TOPIC_FAILED, FILTER_TOPIC_REQUEST, FILTER_TOPIC_SUCCESSFUL, GET_HOME_POSTS_FAILED, GET_HOME_POSTS_REQUEST, GET_HOME_POSTS_SUCCESSFUL, NESTED_POST_LIST_FAILED, NESTED_POST_LIST_REQUEST, NESTED_POST_LIST_SUCCESSFUL, PIN_TO_HOME_FAILED, PIN_TO_HOME_REQUEST, PIN_TO_HOME_SUCCESSFUL, POST_ADD_KEYWORD_FAILED, POST_ADD_KEYWORD_REQUEST, POST_ADD_KEYWORD_SUCCESSFUL, POST_COMMENT_LIST_FAILED, POST_COMMENT_LIST_REQUEST, POST_COMMENT_LIST_SUCCESSFUL, POST_DETAILS_FAILED, POST_DETAILS_REQUEST, POST_DETAILS_SUCCESSFUL, POST_REMOVE_KEYWORD_FAILED, POST_REMOVE_KEYWORD_REQUEST, POST_REMOVE_KEYWORD_SUCCESSFUL, POST_STAT_PER_USER_FAILED, POST_STAT_PER_USER_SUCCESSFUL, RELATED_POST_LIST_FAILED, RELATED_POST_LIST_REQUEST, RELATED_POST_LIST_SUCCESSFUL, SEARCH_POST_FAILED, SEARCH_POST_REQUEST, SEARCH_POST_SUCCESSFUL, SHOW_POST_BY_CAT_FAILED, SHOW_POST_BY_CAT_REQUEST, SHOW_POST_BY_CAT_SUCCESSFUL, SHOW_POST_FAILED, SHOW_POST_REQUEST, SHOW_POST_SUCCESSFUL, SORT_POST_FAILED, SORT_POST_REQUEST, SORT_POST_SUCCESSFUL } from '../constants/postConst';
...
export const statOfUserPosts = (id) => async (dispatch) =>{
    dispatch({
        type: POST_STAT_PER_USER_FAILED
    });
    try {
